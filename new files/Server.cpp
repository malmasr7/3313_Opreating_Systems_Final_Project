...
//****************************************************//
                ...
                //make connections for N clients           
                ...
                if(/*socket==11*/socket==serverIntSockets[2]||socket==serverIntSockets[3]){
                //****Telling the current socket where to write**EDIT HERE**//
                    if(socket==serverIntSockets[2]){
                ...
                if(socket==serverIntSockets[4]||socket==serverIntSockets[5]){
                //****Telling the current socket where to write**EDIT HERE**//
                    if(socket==serverIntSockets[4]){
                        newWrite1 =  mySockets1[4].Write(data);
                    ...
                    if(socket==serverIntSockets[5]){
                            newWrite1 =  mySockets1[5].Write(data);
